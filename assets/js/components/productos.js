      ...
      <div class="single-work text-center mt-30 ">
        ...
        <div class="work-overlay">
          <div class="work-content">
            ...
            <ul>
              <li class="btn-buy"><button type="button" class="agregar" data-id="${id}">+</button></li>
              <li class="btn-price"><a>Price $<i class="fa">${precio}</i></a></li>
              <li class="btn-stock"><a>Stock <i class="fa">${cantidad}</i></a></li>
            </ul>
          </div>
        </div>
      </div>
